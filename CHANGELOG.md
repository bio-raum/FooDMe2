...
### Bugfix
  ...
  - Added the `-A -Q -L` options to `FASTP_METRICS` to prevent any trimming at this point of the workflow. Trimming is performed after primer detection with cutadapt.
