...
for json_file in json_files:
    ...
    # Check discarded proportion for warnings
        # not implemented
...
fig = px.bar(df, x="count", y= "sample", color="label", custom_data="label", hover_name="sample",
    labels={"count": "Read number", "sample": ""},
    orientation='h', template="simple_white")
fig.update_layout(legend={'title_text':''})
fig.update_traces(hovertemplate="%{customdata}<br>%{x}<extra></extra>")
fig.show()
```
...
fig = px.bar(df, x="prop", y= "sample", color="label", custom_data="label", hover_name="sample",
...
fig = px.bar(df, x="count", y= "sample", color="label", custom_data="label", hover_name="sample",
    ...
    orientation='h', template="simple_white")
fig.update_layout(legend={'title_text':''})
fig.update_traces(hovertemplate="%{customdata}<br>%{x} reads<extra></extra>")
fig.show()
```
...
fig = px.bar(df, x="reads", y= "sample", color="rank", custom_data="rank", hover_name="sample",
...
fig = px.bar(df, x="proportion", y= "sample", color="rank", custom_data="rank", hover_name="sample",
    labels={"prop": "Read proportion (%)", "sample": ""},
    orientation='h', template="simple_white")
fig.update_layout(legend={'title_text':''})
fig.update_traces(hovertemplate="%{customdata}<br>%{x}%<extra></extra>")
...
for json_file in json_files:
    ...
    if not full.empty:
        ...
        full = df
# fill NA and keep only one col
full = full.apply(max, axis=1).reset_index().set_axis(["Module", "Software", "Version"], axis=1)
