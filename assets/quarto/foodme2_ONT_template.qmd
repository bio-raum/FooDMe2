...
for json_file in json_files:
    ...
    reads_total = int(int(jdata["fastplong"]["summary"]["before_filtering"]["total_reads"]))
    q20 = round((float(jdata["fastplong"]["summary"]["before_filtering"]["q20_rate"])*100),2)
...
```{python}
#| label: insert_size_after
df = get_insert_hist("nanoplot_trimmed")
