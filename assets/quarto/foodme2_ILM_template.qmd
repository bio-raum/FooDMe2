...
for json_file in json_files:
    ...
    insert_size_label = ["", "Read length", "Insert size peak"]
    insert_size_ttip = ["", "The mean of read lengths", "The peak insert size"]
...
ttips = pd.DataFrame(
    {
        ...
        insert_size_label[reads_passing]: insert_size_ttip[reads_passing],
